...
import { getPenjualanStore } from '../../../Config/Redux/action';
import Gap from '../../gap';
...
export default function PenjualanStore() {
  ...
  const dataStore = useSelector((state)=> state.reducer.getPenjualanStore.data)
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.id_store}</TableCell>
