...
import FormPenjualan from '../../../Page/FormPenjualan/index'
import { useDispatch } from 'react-redux';
import { useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getPenjualanOffice } from '../../../Config/Redux/action';
import Gap from '../../gap';
...
export default function PenjualanOffice() {
  ...
  const dataStore = useSelector((state)=> state.reducer.getPenjualanOffice.data)
          ...
          >
            ...
            <TableBody>
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  const isItemSelected = isSelected(row.id_transaksi);
                  const labelId = `enhanced-table-checkbox-${index}`;

                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, row.id_transaksi)}
                      role="checkbox"
